        ...
        methods: {
            ...
            handler({BMap, map}) {
                ...
                geolocation.getCurrentPosition(r => {
                    ...
                    // 增加圆
                    var circle = new BMap.Circle(_this.center, 110, {
                        strokeColor: '#fff',
                        fillColor: '#6FBFEE',
                        strokeWeight: '2',
                        fillOpacity: '0.3'
                        ...
                        if (e.overlay) {
                            if (e.overlay && e.overlay.toString() !== '[object Circle]') {
                                ...
                                function showInfo(e) {
                                    ...
                                    var place = new BMap.Icon(require('@/assets/img/notice/location.png'), new BMap.Size(40, 50), {});
                ...
                // 自定义当前位置图标
                var myIcon = new BMap.Icon(require('@/assets/img/notice/my-position.png'), new BMap.Size(150, 150), {
